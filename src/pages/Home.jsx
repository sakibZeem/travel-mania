            ...
            <div className="hero min-h-screen bg-hero-pattern  bg-transparent" >
                ...
                <div className='hero-content flex justify-between text-white'>
                    <div className='space-y-4 w-3/4'>
                        <h1 className='text-7xl'>Coxs bazar</h1>
                        <p>Coxs Bazar is a city, fishing port, tourism centre and district headquarters in southeastern Bangladesh. It is famous mostly for its long natural sandy beach.</p>
